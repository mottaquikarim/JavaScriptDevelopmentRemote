(function() { // protect the lemmings!
	...
	for (let i = 0; i < $pageHeaderLIs.length; i++) {
		const currentLi = $pageHeaderLIs[i]
	...
	console.log('lol fat arrow function')
	const actives = $pageHeaderLIs.filter((idx, el) => {
		console.log(el)
	...
	console.log(Array.from($pageHeaderLIs).filter(el => {
		return $(el).hasClass('active');
	}))

	// console.log('old school cool')
	// $pageHeaderLIs.each(function() {
